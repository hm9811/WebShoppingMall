...
namespace WebShoppingMall.Controllers
{
    ...
    public class PhotoProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PhotoId,ProductId,Title,Descriptions")] PhotoProduct photoProduct)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PhotoId,ProductId,Title,Descriptions")] PhotoProduct photoProduct)
        {
